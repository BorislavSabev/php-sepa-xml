...
class CustomerCreditFacadeTest extends TestCase
{
    ...
    public function testValidFileCreationWithFacade(string $schema): void
    {
        ...
        $paymentInformation = $credit->addPaymentInfo(
            'firstPayment',
            ['id' => 'firstPayment', 'debtorName' => 'My Company', 'debtorAccountIBAN' => 'FI1350001540000056', 'debtorAgentBIC' => 'PSSTFRPPMON']
        );
        $paymentInformation->setBatchBooking(true);

        $credit->addTransfer(
            'firstPayment',
            ['amount' => 500, 'creditorIban' => 'FI1350001540000056', 'creditorBic' => 'OKOYFIHH', 'creditorName' => 'Their Company', 'remittanceInformation' => 'Purpose of this credit']
        );
    ...
    public function testValidFileCreationWithFacadeWithoutDebtorBic(string $schema): void
    {
        ...
        $paymentInformation = $credit->addPaymentInfo(
            'firstPayment',
            ['id' => 'firstPayment', 'debtorName' => 'My Company', 'debtorAccountIBAN' => 'FI1350001540000056']
        );
        $paymentInformation->setBatchBooking(true);

        $credit->addTransfer(
            'firstPayment',
            ['amount' => 500, 'creditorIban' => 'FI1350001540000056', 'creditorName' => 'Their Company', 'remittanceInformation' => 'Purpose of this credit']
        );
    ...
    {
        return [["pain.001.001.03"], ["pain.001.002.03"], ["pain.001.003.03"]];
    }

    public function schemaProviderEmptyBic(): iterable
    {
        return [["pain.001.001.03"], ["pain.001.003.03"]];
    }
}
